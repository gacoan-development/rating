                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style=" font-size: 14px; color:#717171;">Kami dari Divisi IT ingin terus
                                        berinovasi dan memberikan pelayanan terbaik untuk kalian semua. Untuk itu, kami
                                        butuh bantuan dan masukan dari kalian! Mohon luangkan sedikit waktu untuk
                                        mengisi kuisioner berikut:,</p>
                                    <p style=" font-size: 14px; color:#717171;">Masukan dari kalian sangat berarti untuk
                                        kemajuan Divisi IT agar lebih baik lagi ke depannya. Terima kasih banyak atas
                                        partisipasinya! </p>
                                    <p style=" font-size: 14px; color:#717171;"><b><i>#ITLebihBaik
                                                #GacoanBersamaIT</i></b></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <form method="POST" action="save-rating.php">
                        <table class="order-template" border="0" cellpadding="0" cellspacing="0" align="left"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding-left: 15px;">
                                        <div class="star-rating" id="staff_friendliness">
                                            <!-- Rating 5 -->
                                            <input type="radio" id="staff_friendliness_5" name="staff_friendliness"
                                                value="5">
                                            <label for="staff_friendliness_5">&#9733;</label>

                                            <!-- Rating 4 -->
                                            <input type="radio" id="staff_friendliness_4" name="staff_friendliness"
                                                value="4">
                                            <label for="staff_friendliness_4">&#9733;</label>

                                            <!-- Rating 3 -->
                                            <input type="radio" id="staff_friendliness_3" name="staff_friendliness"
                                                value="3">
                                            <label for="staff_friendliness_3">&#9733;</label>

                                            <!-- Rating 2 -->
                                            <input type="radio" id="staff_friendliness_2" name="staff_friendliness"
                                                value="2">
                                            <label for="staff_friendliness_2">&#9733;</label>

                                            <!-- Rating 1 -->
                                            <input type="radio" id="staff_friendliness_1" name="staff_friendliness"
                                                value="1">
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding-left: 15px;">
                                        <div class="star-rating" id="service_expectation">
                                            <!-- Rating 5 -->
                                            <input type="radio" id="service_expectation_5" name="service_expectation"
                                                value="5">
                                            <label for="service_expectation_5">&#9733;</label>

                                            <!-- Rating 4 -->
                                            <input type="radio" id="service_expectation_4" name="service_expectation"
                                                value="4">
                                            <label for="service_expectation_4">&#9733;</label>

                                            <!-- Rating 3 -->
                                            <input type="radio" id="service_expectation_3" name="service_expectation"
                                                value="3">
                                            <label for="service_expectation_3">&#9733;</label>

                                            <!-- Rating 2 -->
                                            <input type="radio" id="service_expectation_2" name="service_expectation"
                                                value="2">
                                            <label for="service_expectation_2">&#9733;</label>

                                            <!-- Rating 1 -->
                                            <input type="radio" id="service_expectation_1" name="service_expectation"
                                                value="1">
                                ...
                                <tr>
                                    ...
                                    <td valign="top" style="padding-left: 15px;">
                                        <div class="star-rating" id="overall_satisfaction">
                                            <!-- Rating 5 -->
                                            <input type="radio" id="overall_satisfaction_5" name="overall_satisfaction"
                                                value="5">
                                            <label for="overall_satisfaction_5">&#9733;</label>

                                            <!-- Rating 4 -->
                                            <input type="radio" id="overall_satisfaction_4" name="overall_satisfaction"
                                                value="4">
                                            <label for="overall_satisfaction_4">&#9733;</label>

                                            <!-- Rating 3 -->
                                            <input type="radio" id="overall_satisfaction_3" name="overall_satisfaction"
                                                value="3">
                                            <label for="overall_satisfaction_3">&#9733;</label>

                                            <!-- Rating 2 -->
                                            <input type="radio" id="overall_satisfaction_2" name="overall_satisfaction"
                                                value="2">
                                            <label for="overall_satisfaction_2">&#9733;</label>

                                            <!-- Rating 1 -->
                                            <input type="radio" id="overall_satisfaction_1" name="overall_satisfaction"
                                                value="1">
                                ...
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="margin-top: 15px; font-size: 16px; font-weight: bold; color: #333;">
                                        Berikan masukan Anda untuk membangun kami agar lebih baik di kemudian hari
                                    </h5>
                                    <textarea name="feedback" placeholder="Tulis masukan Anda di sini..." style="width: 170%; min-height: 120px; padding: 10px; font-size: 14px; 
                   border: 1px solid #ccc; border-radius: 8px; resize: vertical; 
                   outline: none; transition: border-color 0.3s ease-in-out;"
                                        onfocus="this.style.borderColor='#007BFF'"
                                        onblur="this.style.borderColor='#ccc'" required></textarea>
                                </td>
                            </tbody>
                        </table>
                        <div class="btn-showcase">
                            <button class="btn btn-square btn-primary" type="submit" name="submit">Kirim
                                Feedback</button>
                        </div>
                    </form>
                    <table class="temp-social main-bg-light text-center" align="center" border="0" cellpadding="0"
                                ...
                                <td style="padding: 30px;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p style="font-size:14px; margin:8px 0; color:#717171;">2025 Copy
                                                        Right by MieGacoan</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><a href="javascript:void(0)"
                                                        style="color: #3e5fce;font-size: 14px;text-transform: capitalize;font-weight:600; margin:0;">
                                                        by PT Pesta Pora Abadi</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
